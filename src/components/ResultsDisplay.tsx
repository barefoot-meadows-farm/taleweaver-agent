...
const ResultsDisplay = ({ userStory, onReset }: ResultsDisplayProps) => {
  ...
  return (
    <Card className="w-full max-w-2xl p-6 glass-panel animate-fade-in space-y-6">
      ...
      <div className="p-4 bg-accent/50 rounded-md whitespace-pre-wrap text-foreground">
        {userStory.userStory}
      </div>
