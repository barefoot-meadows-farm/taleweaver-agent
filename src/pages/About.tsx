...
const About = () => {
  ...
  return (
    <>
      <Helmet>
        <title>About Story Gen - AI User Story Generator for Agile Teams</title>
        <meta name="description" content="Learn how Story Gen uses AI agents including Business Analysts, Product Owners, QA Engineers, and Technical Architects to create comprehensive user stories for Agile teams." />
        <meta name="keywords" content="user story generator, agile development, AI story generation, product backlog, sprint planning, agile requirements" />
      ...
      <div className="min-h-screen px-4 py-12 sm:py-20 bg-gradient-to-br from-background via-accent/20 to-background/90">
        <div className="max-w-4xl mx-auto">
          ...
          <section className="mb-16" aria-labelledby="how-it-works">
            <h2 id="how-it-works" className="text-3xl font-bold mb-8 text-center">How It Works</h2>
          ...
          <section className="mb-16" aria-labelledby="ai-agents">
            <h2 id="ai-agents" className="text-3xl font-bold mb-8 text-center">Our AI Agents</h2>
          ...
          <section className="mb-16" aria-labelledby="benefits">
            <h2 id="benefits" className="text-3xl font-bold mb-8 text-center">Benefits</h2>
